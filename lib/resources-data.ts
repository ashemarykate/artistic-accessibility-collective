...
//
// ORGANIZATION: Geographic — Worldwide first (online-accessible from anywhere),
// then by country/region. Within each section, online/digital resources appear
// before location-specific organizations and events.
...
export const CATEGORIES: Category[] = [
  // ─────────────────────────────────────────────────────────────────────────────
  // WORLDWIDE / ONLINE
  // Standards, tools, frameworks, and foundational texts — no specific jurisdiction,
  // accessible from anywhere.
  // ─────────────────────────────────────────────────────────────────────────────
  {
    id: 'worldwide',
    title: 'Worldwide / Online',
    emoji: '🌐',
    description: 'International standards, digital tools, and foundational texts accessible from anywhere — not tied to a specific country\'s law or in-person presence.',
    resources: [
      ...
      // ── Disability Justice — Foundational Texts ───────────────────────────
      ...
      // ── International Journals & Organizations ────────────────────────────
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // UNITED STATES
  // Resources grounded in US law (ADA, CVAA, Section 508) or primarily serving
  // US practitioners. Online resources listed before location-specific ones.
  // ─────────────────────────────────────────────────────────────────────────────
  {
    id: 'united-states',
    title: 'United States',
    emoji: '🇺🇸',
    description: 'Resources rooted in US law (ADA, CVAA, Section 508, NEA) or primarily serving US practitioners — from federal policy to city-level organizations.',
    resources: [

      // ── Federal Law & Policy ──────────────────────────────────────────────
      { name: 'ADA.gov', url: 'https://www.ada.gov', description: 'The authoritative free source for all Americans with Disabilities Act guidance. Focus on Title III (public accommodations — most relevant to arts venues). Includes DOJ web accessibility guidance and the 2024 final rule requiring WCAG 2.1 AA for state and local government websites.', type: 'standard', tags: ['FREE'] },
      { name: 'ADA National Network', url: 'https://adata.org', description: 'Ten regional centers (one per US region) offering free ADA training, webinars, detailed guides, and a live helpline: 1-800-949-4232. The most accessible entry point for arts organizations trying to understand their ADA obligations.', type: 'org', tags: ['FREE'] },
      { name: 'FCC — Closed Captioning on Television', url: 'https://www.fcc.gov/consumers/guides/closed-captioning-television', description: 'FCC guide to captioning requirements under the CVAA and the four FCC quality standards: accuracy, synchrony, completeness, and placement. Essential background for film, broadcast, and streaming accessibility work in the US.', type: 'standard', tags: ['FREE'] },
      { name: 'National Endowment for the Arts — Accessibility', url: 'https://www.arts.gov/impact/accessibility', description: 'Free policy guidance, case studies, and vetted resource links for arts organizations. Accessibility is increasingly required in NEA grant criteria — this is the place to understand what NEA expects and what they fund.', type: 'org', tags: ['FREE'] },
      { name: 'W3C WCAG Standards (US Legal Context)', url: 'https://www.w3.org/WAI/standards-guidelines/wcag', description: 'WCAG 2.1 is the current US legal standard for web accessibility (confirmed by DOJ in 2022 for Title II and III entities). WCAG 2.2 (October 2023) is current best practice. Free and authoritative — this is what you cite for US legal compliance.', type: 'standard', tags: ['FREE', 'Open Access'] },

      // ── Audio Description (US-based orgs) ────────────────────────────────
      ...
      { name: 'GBH Media Access Group', url: 'https://www.wgbh.org/foundation/media-access', description: 'Created the first broadcast audio description in the US (Described Video Service). Now a leader in captioning and AD research and advocacy. The institutional origin of much US accessibility infrastructure.', type: 'org', tags: ['FREE'] },
      { name: 'Art Beyond Sight', url: 'https://www.artbeyondsight.org', description: 'US-based organization focused on making visual art, museum collections, and gallery experiences accessible to blind and low-vision audiences through verbal description. Resources, research, and training.', type: 'org', tags: ['FREE'] },

      // ── Captioning (US-based) ─────────────────────────────────────────────
      { name: 'DCMP Captioning Key', url: 'https://dcmp.org/learn/captioningkey', description: 'The most detailed and widely-used quality standard for captions in educational media — broadly applied across the industry. Covers accuracy, placement, speaker identification, and sound effects. The US captioner\'s go-to reference.', type: 'standard', tags: ['FREE'] },
      ...
      // ── Digital Accessibility (US-based orgs & tools) ─────────────────────
      ...
      { name: 'RespectAbility', url: 'https://www.respectability.org', description: 'US coalition with resources on disability inclusion in entertainment. Runs an Entertainment Lab for disabled writers and a free Media Guide for journalists and critics covering disability representation.', type: 'org', tags: ['FREE'] },
      ...
      { name: 'ReelAbilities Film Festival', url: 'https://reelabilities.org', description: 'US disability-focused film festival with strong access practices, free educational programming, and chapters in 20+ cities. An important showcase for disability-centered storytelling with broad geographic reach.', type: 'org', tags: ['FREE'] },
      { name: 'Disability Film Challenge', url: 'https://www.disabilityfilmchallenge.com', description: 'Annual US filmmaking competition promoting authentic disability storytelling by and with disabled creators. Free to enter. Held at Sony Pictures Studios (Los Angeles). Good gateway for emerging disabled filmmakers.', type: 'org', tags: ['FREE'] },

      // ── Deaf Culture (US) ─────────────────────────────────────────────────
      { name: 'National Association of the Deaf (NAD)', url: 'https://www.nad.org', description: 'The leading US Deaf advocacy organization. Free position papers on captioning, cochlear implants, ASL recognition, and Deaf civil rights. Essential reading for understanding the Deaf community\'s own advocacy positions — not what hearing organizations say about Deaf people.', type: 'org', tags: ['FREE', 'Deaf-Centered'] },
      ...
      // ── Disability Justice (US-based orgs) ────────────────────────────────
      ...
      { name: 'Autistic Self Advocacy Network (ASAN)', url: 'https://autisticadvocacy.org', description: 'The leading US autistic-led disability rights organization. ASAN is the correct organization to reference for sensory-friendly programming guidance — not Autism Speaks. Free toolkits, policy positions, and guides on neurodivergent inclusion developed by autistic people.', type: 'org', tags: ['FREE', 'Disabled Voice'] },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // CANADA
  // Federal: Accessible Canada Act (2019). Provinces vary significantly —
  // Ontario has AODA (2005), the most developed provincial accessibility legislation.
  // ─────────────────────────────────────────────────────────────────────────────
  {
    id: 'canada',
    title: 'Canada',
    emoji: '🇨🇦',
    description: 'Canadian resources — governed federally by the Accessible Canada Act (2019). Provinces vary: Ontario\'s AODA (2005) is the most developed provincial accessibility law. Quebec adds French-language accessibility considerations.',
    resources: [
      { name: 'Accessible Canada — Accessible Canada Act Resources', url: 'https://accessible.canada.ca', description: 'Free resources on the Accessible Canada Act (2019) — Canada\'s federal accessibility legislation covering broadcasting, telecommunications, banking, and federal government. The foundation for federal arts organizations and broadcasters in Canada.', type: 'standard', tags: ['FREE'] },
      { name: 'VocalEye — Live Performance Audio Description', url: 'https://vocaleye.ca', description: 'Canada\'s leading organization for live performance audio description. Offers freely available guidelines for live theater AD, describer training resources, and guidance for dance and experimental performance. Among the best published live AD resources in the English-speaking world.', type: 'org', tags: ['FREE'] },
      { name: 'CELA — Centre for Equitable Library Access', url: 'https://celalibrary.ca', description: 'Canada\'s national accessible library service — the equivalent of the US NLS/BARD. Talking books, braille, and DAISY format in English and French, accessible to Canadians with print disabilities. Free with registration through member libraries.', type: 'org', tags: ['FREE'] },
  ...
  // Australia: Disability Discrimination Act (1992); ACMA captioning quotas.
  // NZ: Human Rights Act 1993 covers disability.
  // ─────────────────────────────────────────────────────────────────────────────
  {
    id: 'australia-nz',
    title: 'Australia & New Zealand',
    emoji: '🇦🇺',
    description: 'Australia and New Zealand resources. Australia is governed by the Disability Discrimination Act (1992) with ACMA captioning/AD requirements for broadcasters. NZ is governed by the Human Rights Act 1993.',
    resources: [
      { name: 'Arts Access Australia', url: 'https://artsaccessaustralia.org', description: 'Australia\'s national peak body for arts and disability — the equivalent of Americans for the Arts in the US, but with a dedicated disability arts focus. Free resources, sector development guides, and advocacy for accessible arts programming nationwide.', type: 'org', tags: ['FREE'] },
      { name: 'Access2Arts', url: 'https://access2arts.org.au', description: 'Adelaide-based Australian organization offering the country\'s most developed professional training in audio description and captioning for the arts. Their 12-week AD course is a leading professional training program in the Asia-Pacific region. Free introductory resources available.', type: 'org', tags: ['FREE'] },
      { name: 'Accessible Arts NSW', url: 'https://accessiblearts.org.au', description: 'New South Wales-based arts and disability organization. Free training, resources, and advocacy for accessible arts programming in NSW and applicable more broadly across Australia.', type: 'org', tags: ['FREE'] },
      { name: 'Arts Access Aotearoa', url: 'https://artsaccess.org.nz', description: 'New Zealand\'s national organization for arts and disability. Free resources and advocacy for accessible arts, accessible venues, and disability arts programming across Aotearoa New Zealand.', type: 'org', tags: ['FREE'] },
    ],
  },
];
