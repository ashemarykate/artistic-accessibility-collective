...
export const CATEGORIES: Category[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: '1IN4 Coalition', url: 'https://1in4coalition.com', description: 'Coalition of disabled creatives working to change representation and hiring in film and television, named for the roughly one in four people who are disabled. Advocacy, community, and industry resources centering disabled writers, directors, and crew. Free to access.', type: 'org', tags: ['FREE', 'Disabled Voice'], location: 'United States' },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    resources: [
      ...
      { name: 'Recommendations for Accessibility (Sins Invalid)', url: 'https://www.sinsinvalid.org/blog/access-suggestions-for-a-public-event', description: 'Sins Invalid\'s widely shared, practical checklist of access suggestions for public events, grounded in disability justice rather than minimum compliance: fragrance-free practice, ASL and CART, image description, mobility access, and more. A free, copy-ready starting point for organizers.', type: 'guide', tags: ['FREE', 'Disabled Voice'] },
    ],
  },
