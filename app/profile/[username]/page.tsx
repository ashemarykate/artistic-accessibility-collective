    ...
    <main style={{ background: bgColor, minHeight: '100%', paddingBottom: '24px' }}>
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '12px 10px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <div id="main-content" style={{ width: '100%' }}>
          ...
          {/* ── Volunteering ── */}
          {profile.volunteer_status === 'yes' && (
            <MsBox header={`🌱 ${firstName} Volunteers`}>
              <div className="ms-box-body">
                <p style={{ margin: '0 0 6px', fontSize: '0.875rem', color: 'var(--aac-blue)', fontWeight: 'bold' }}>
                  Open to volunteering for the right gig
                </p>
                <p style={{ margin: '0 0 4px', fontSize: '0.8125rem', color: 'var(--color-text-muted)' }}>
                  {firstName} is available to donate their skills for low-income, community, or grassroots efforts.
                </p>
                {profile.volunteer_notes && (
                  <p style={{ margin: '8px 0 0', fontSize: '0.875rem', lineHeight: 1.5, whiteSpace: 'pre-wrap' }}>
                    {profile.volunteer_notes}
                  </p>
                )}
              </div>
