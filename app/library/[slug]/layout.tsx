...
import { LIBRARY_ITEM_BY_SLUG } from '@/lib/library-data';
...
export async function generateMetadata({
  ...
  const item = LIBRARY_ITEM_BY_SLUG[slug];
  return { title: item ? `${item.title} · The Library · AAC` : 'The Library · Artistic Accessibility Collective' };
}
