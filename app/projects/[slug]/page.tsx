 ...
 * else, so the same URL is a 404 for a patron. That's what the Preview page
 * link in the admin panel relies on, and it's why there's a visible draft
...
import {
  fetchProductionBySlug, formatDate, isPast, kindLabel, upcomingDates,
} from '@/lib/productions';
import { isBlankHtml, sanitizeHtml } from '@/lib/sanitize-html';
import {
  AccessChips, Banner, ElsewhereModule, Module, PostBodyStyles, PostFrame, X, XangaLayout, navLink, pageBackground,
} from '../xanga-ui';
...
export default function ProductionPage() {
  ...
  return shell(
    ...
    `${p.title} · Current Projects & Events · Artistic Accessibility Collective`,
  );
}
